...
riot.tag2('main-nav', '<nav class="navigation"> <notif store="{opts.store}"></notif> <section class="container"> <a class="navigation-title float-left" href="#/"> <h1 class="title"> <img class="logo" src="/img/appii_logo.png"> </h1> </a> <ul class="navigation-list float-left"> <li class="navigation-item"> <a class="navigation-link" href="#/professionals">Professionals</a> </li> <li class="navigation-item"> <a class="navigation-link" href="#/organizations">Companies</a> </li> <li class="navigation-item"> <a class="navigation-link" href="#/universities">Universities</a> </li> </ul> <ul class="navigation-list float-right"> <li class="navigation-item" if="{dev || prod_host == \'appii1\'}"> <a class="navigation-link" href="#/user">Profile</a> </li> <li class="navigation-item" if="{dev || prod_host != \'appii1\'}"> <a class="navigation-link" href="#/org">Organization</a> </li> </ul> </section> </nav>', '', '', function(opts) {
    (function() {
...
riot.tag2('home', '<div class="row"> <div class="column"> <img class="hero full" src="/img/home_cover.jpg"> </div> </div> <div class="box"> <div class="row"> <div class="column"> <p> APPII is the right place to find your next position. If you are a Company looking to hire a new talent, that\'s the right place. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In consequat mauris et ante pretium ultricies. <br> ctetur adipiscing elit. In consequat mauris et elit. In consequat mauris et ante pretium ultricies..... <br> </p> </div> </div> </div> <div class="s30"></div> <div class="box"> <div class="row"> <div class="column"> <h5>For Companies:</h5> <h3>Find a Professional</h3> </div> </div> <div class="row"> <div class="column"> <user-face each="{users}"></user-face> </div> </div> <div class="s20"></div> </div> <div class="s30"></div> <div class="box"> <div class="row"> <div class="column"> <h5>For You:</h5> <h3>Find a Position</h3> </div> </div> <div class="row"> <div class="column"> <org-face each="{orgs}"></org-face> </div> </div> </div>', '', '', function(opts) {
    (function() {
...
riot.tag2('table-users', '<div class="box"> <p>Search</p> <input name="query" onkeyup="{filterUsers}" placeholder="enter a skill or a location" type="text"> <div class="s10"></div> </div> <div class="s30"></div> <div class="box"> <table> <thead> <tr> <th></th> <th>Name</th> <th>Job title</th> </tr> </thead> <tr each="{users}"> <td> <a href="#/users/{id}"> <img class="avatar" riot-src="{avatar}"> </a> </td> <td> <a href="#/users/{id}"> {name} </a> </td> <td>{jobTitle()}</td> </tr> </table> </div>', '', '', function(opts) {
    (function() {
      var matchString;
...
riot.tag2('table-orgs', '<div class="box"> <p>Search</p> <input name="query" onkeyup="{filterOrgs}" placeholder="enter a company name, an industry or a location" type="text"> <div class="s10"></div> </div> <div class="s30"></div> <div class="box"> <table> <thead> <tr> <th></th> <th>Name</th> <th>Industry</th> <th>Location</th> <th>Employees</th> </tr> </thead> <tr each="{orgs}"> <td> <a href="#/orgs/{id}"> <img class="avatar" riot-src="{avatar}"> </a> </td> <td> <a href="#/orgs/{id}"> {name} </a> </td> <td>{industry}</td> <td>{location}</td> <td>{employees}</td> </tr> </table> </div>', '', '', function(opts) {
    (function() {
...
riot.tag2('user', '<div class="row"> <div class="column"> <unsplash-cover store="{store}"></unsplash-cover> </div> </div> <div class="over-user"> <div class="box box-main"> <div class="row"> <div class="column"> <img class="avatar left" riot-src="{user.avatarLg}"> <div class="user-main-details left"> <h2>{user.name}</h2> <h4>{user.jobTitle()}</h4> <p>{user.location}</p> <button>Send a message</button> </div> <div class="clear"></div> </div> </div> <div class="row"> <div class="column"> <div class="profile-link"> http://appii.io/profile.link </div> </div> </div> </div> <div class="s20"></div> <div class="box"> <h3>Background</h3> <div class="h3-space"></div> <div class="row"> <div class="column"> <p class="gray"> {user.bio || lipsum} </p> <p> <strong>Nationality:</strong> {user.nationality} </p> </div> </div> </div> <div class="s20"></div> <div class="box"> <h3>Skills</h3> <div class="h3-space"></div> <div class="row skills"> <div class="column" each="{skill, level in skills}"> {s.capitalize(skill)} {_(Number(level)).times(stars).join(⁗⁗)} </div> <div class="column"> {noSkillsMessage()} </div> </div> <div class="clear"></div> </div> <div class="s50"></div> <div class="box"> <h3>Experience</h3> <div class="h3-space"></div> <section class="positions"> <div each="{empl in empls}"> <h4> {empl.role != ⁗-⁗ ? empl.role : ⁗Employee⁗} <span class="empl-status {empl.approved ? \'approved\' : \'pending\'} hint--bottom hint--rounded" data-hint="{empl.approvedAtString()}"> {empl.approved ? \'✓ approved\' : \'·	·	· &nbsp; pending approval\'} </span> </h4> <h5> <a href="/#/orgs/{empl.org.id}">{empl.org.name}</a> </h5> <p>{empl.dateRange()}</p> <p> {empl.desc != ⁗-⁗ ? empl.desc : ⁗Lorem ipsum dolor sit amet, consectetur adipiscing elit. In consequat mauris et ante pretium ultricies.⁗} </p> </div> </section> <div class="row"> <div class="column"> {noPosMessage()} </div> </div> </div> <div class="s30"></div> <div class="box"> <div class="gray"> <h3>Education</h3> <div class="h3-space"></div> <h5>Degree in Astrophysics</h5> <h5>UCL</h5> <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. In consequat mauris et ante pretium ultricies. Curabitur eget ante eu enim efficitur congue. Praesent non condimentum turpis. </p> </div> </div> <div class="s30"></div> <publickeyuser store="{store}"></publicKeyUser> </div>', '', '', function(opts) {
    (function() {
      var entry_id;
...
riot.tag2('publickeyorg', '<div class="row"> <div class="column right"> <div class="s20"></div> <p> organization type <br> {org.orgType} </p> <p> <div class="hint--bottom-left hint--rounded icon-mini" data-hint="{org.publicKey}">🔑</div> <br> <span class="hint--bottom-left hint--rounded" data-hint="{org.publicKey}">publicKey</span> <br> <span class="hint--bottom-left hint--rounded" data-hint="{org.publicKey}">{org.publicKeyShort}</span> </p> </div> </div>', '', '', function(opts) {
    (function() {
      var entry_id;
...
riot.tag2('unsplash-cover', '<img class="unsplash" riot-src="https://unsplash.it/1200/430/?image={Number(entry_id) || user.id}"> <div class="unsplash-spacer"></div>', '.unsplash { width: 100%; left: 0; top: 50px; position: absolute; z-index: 0; border-bottom: 3px solid #DDD; } .unsplash-spacer { height: 430px; }', '', function(opts) {
    (function() {
      var entry_id;
...
riot.tag2('blockchain', '<div class="box"> <div class="blocks"> <h1>Blockchain</h1> <div class="block" each="{block in blocks}"> <h5> Block # {block.number} <span>- hash: {block.hash}</span> </h5> <p> <strong>Mined by:</strong> {block.miner} </p> <p> <strong>Timestamp:</strong> {new Date(block.timestamp*1000).toDateString()} - {new Date(block.timestamp*1000).toTimeString()} </p> <h5>Transactions:</h5> <div class="tx" each="{tx in block.transactions}"> <p> <strong>Hash:</strong> {tx.hash} </p> <p> <strong>From:</strong> {tx.from} </p> <p> <strong>To:</strong> {tx.to} </p> <p> <strong>Smart Contract: {tx.method.contract} - Method: {tx.method.name}</strong> </p> <h5> Values: <val each="{name, value in tx.method.values}"></val> </h5> <div class="s20"></div> </div> <div class="s50"></div> </div> </div> </div>', '.block span { font-size: 0.8em; } .tx { padding-left: 30px; } .block .tx { } .block p { margin-bottom: 10px; }', '', function(opts) {
      (function() {
        this.blocks = [];
...
riot.tag2('val', '<span> <strong>{s.ltrim(name, ⁗_⁗)}:</strong> <raw content="{autolink(tx.method.contract, name, value)}, "></raw> </span>', '', '', function(opts) {
    (function() {

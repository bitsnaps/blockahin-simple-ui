...
riot.tag2('unsplash-cover', '<img class="unsplash" riot-src="https://unsplash.it/1200/250/?image={Number(entry_id) || user.id}"> <div class="unsplash-spacer"></div>', '.unsplash { width: 100%; left: 0; top: 50px; position: absolute; z-index: 0; border-bottom: 3px solid #DDD; } .unsplash-spacer { height: 250px; }', '', function(opts) {
    (function() {
      var entry_id;

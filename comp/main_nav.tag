<main-nav>
  <nav class="navigation">
  	<section class="container">
        ...
        <svg class="img" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16" viewBox="0 0 16 16">
          ...
          <a class="navigation-link" href="#/organization">Organization</a>
  			</li>
  		</ul>
